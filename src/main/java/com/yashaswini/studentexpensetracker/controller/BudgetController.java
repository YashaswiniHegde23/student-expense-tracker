...
public class BudgetController {
    ...
    @PostMapping
    public String setBudget(@Valid @RequestBody BudgetRequest request) {
    ...
    public String updateBudget(
        ...
        return budgetService.updateBudget(userId, request);
    }
    ...
    public BudgetStatusResponse getBudgetStatus(
        ...
        return budgetService.getBudgetStatus(userId, month, year);
    }
}